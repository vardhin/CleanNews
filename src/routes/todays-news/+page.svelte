<script>
    ...
    // Fetch the featured article and its related articles
    ...
    <main class="container">
        ...
        {:else}
            <div class="error-container">
                ...
                <p>The article you're looking for could not be found. It may have been removed or you might have followed an invalid link.</p>
            </div>
        {/if}
    </main>
</div>
